...
class HomeType(models.Model):
   ...
   description = models.TextField(blank=True)
   image = models.ImageField(upload_to="home_types/", blank=True, null=True)
   ...
   def get_absolute_url(self):
      return reverse("home_type_detail", kwargs={"slug": self.slug})



class Home(models.Model):
   home_type = models.ForeignKey(HomeType, on_delete=models.SET_NULL, null=True, blank=True, related_name="homes")
   category = models.ForeignKey(Category, on_delete=models.SET_NULL, null=True, blank=True, related_name="homes")
